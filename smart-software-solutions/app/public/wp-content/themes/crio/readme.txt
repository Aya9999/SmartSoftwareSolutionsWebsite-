=== Crio ===
Contributors: boldgrid, timph, rramo012, bgnicolepaschen, joemoto, imh_brad, jamesros161
...
Crio is a WordPress SuperTheme that allows designers, developers and other web professionals to create without bounds.
...
= 2.4.0 =
New Feature: Increased flexibility of page / post / woocommerce templates to allow better compatibility with Crio Pro's Custom Page Headers [#100] (https://github.com/BoldGrid/crio/pull/100)

= 2.3.0 =
New Feature: Added compatibility with Crio Page Header Templates. [#94] (https://github.com/BoldGrid/crio/pull/94)

= 2.2.13 =
Bug Fix: Cannot use Crio Customizer with Sprout Invoices [#93] (https://github.com/BoldGrid/crio/issues/93)
...
= 2.2.9 =
* Bug fix: Shop pages showing multiple H1 headings. [#66](https://github.com/BoldGrid/crio/issues/66)
...
* Update: Changed some of the welcome page content to better assist new users with a fresh site in getting started. [#53](https://github.com/BoldGrid/crio/issues/53), [#54](https://github.com/BoldGrid/crio/issues/54)
...
* Update: Updated theme dashboard support information. [#48](https://github.com/BoldGrid/crio/issues/48)
...
* Update: Crio now uses the standard header/footer "generic" templates.
